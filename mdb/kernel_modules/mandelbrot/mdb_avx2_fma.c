...
static inline
void set_pixels(__m256 v_i, uint32_t x, uint32_t y, uint32_t bailout)
{
...
__m256 mdb_point_probe(__m256 v_cx, __m256 v_cy, uint32_t bailout)
{
        ...
        for (; i < bailout; ++i)
        {
                 ...
                 */
                v_mag2 = _mm256_fmadd_ps(v_zx1, v_zx1,
                                         _mm256_mul_ps(v_zy1, v_zy1));
